...
class SalaController extends Controller
{
    ...
    public function indexSessao()
    {
        ...
        return view('admin.sessao.index', compact('sala'));
    }
    ...
    public function editSessao($id)
    {
        $shopping = $this->shoppingRepository->all();

        $sala = $this->repository->find($id);

        return view('admin.sessao.edit', compact('sala', 'shopping'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function updateSessao(Request $request, $id)
    {
        $data = $request->all();
     ...
     * @return \Illuminate\Http\Response
     */
    public function destroySessao($id)
    {
        $this->repository->delete($id);
